...
ACLOCAL = ${SHELL} /root/workspace/ics-project/json-c/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/workspace/ics-project/json-c/missing autoconf
AUTOHEADER = ${SHELL} /root/workspace/ics-project/json-c/missing autoheader
AUTOMAKE = ${SHELL} /root/workspace/ics-project/json-c/missing automake-1.15
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /root/workspace/ics-project/json-c/missing makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 0.12.99
abs_builddir = /root/workspace/ics-project/json-c
abs_srcdir = /root/workspace/ics-project/json-c
abs_top_builddir = /root/workspace/ics-project/json-c
abs_top_srcdir = /root/workspace/ics-project/json-c
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/workspace/ics-project/json-c/install-sh
...
pdfdir = ${docdir}
prefix = /root/workspace/ics-project/json-c/../libs/linux-i686
...
#libjsonx_includedir = $(libdir)/json-c-0.12.99
#
#libjsonx_include_HEADERS = \
#	json_config.h
libjson_c_la_LDFLAGS = -version-info 3:0:0 -no-undefined -Wl,-Bsymbolic-functions
...
include ./$(DEPDIR)/random_seed.Plo
